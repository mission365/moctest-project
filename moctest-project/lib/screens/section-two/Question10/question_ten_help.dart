...
import 'package:moctest_project/screens/section-two/Question10/question_ten.dart';


class QuestionTenHelp extends StatefulWidget {
  const QuestionTenHelp({super.key});

  @override
  State<QuestionTenHelp> createState() => _HelpPageState();
}

class _HelpPageState extends State<QuestionTenHelp> {
            ...
            children: [
              ...
              const Text.rich(
                TextSpan(
                  children: [
                    TextSpan(
                      text: 'Select a single answer choice.', // Regular text before "Continue"
              ...
              SizedBox(height: 10),
              Text(
                "To select an answer choice, click on it or select it with the keyboard. To deselect a choice, click on it again or select another choice.",
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => QuestionTen()),
                                );
                              },
                              child: Container(
                                color: Color(0xFF365E90),
