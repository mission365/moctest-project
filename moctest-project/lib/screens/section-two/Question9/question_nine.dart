...
import 'package:moctest_project/screens/section-two/Question9/question_nine_help.dart';
import '../Question10/question_ten.dart';
import '../Question8/question_eight.dart';
...
class _TestCenterState extends State<QuestionNine> {
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => QuestionNineHelp() ),
                                );
                              },
                              child: Container(
                                color: Color(0xFF4D4C4D),
                    ...
                    child:  const Text.rich(
                      TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: ' | Question 9 of 12', // The bold "Continue"
                            style: TextStyle(
                              fontSize: 13,
                            ),
                          ),
