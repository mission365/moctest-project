...
import 'package:moctest_project/screens/section-two/Question5/question_five.dart';
class QuestionFourHelp extends StatefulWidget {
  const QuestionFourHelp({super.key});

  @override
  State<QuestionFourHelp> createState() => _HelpPageState();
}

class _HelpPageState extends State<QuestionFourHelp> {
            ...
            children: [
              ...
              const Text.rich(
                TextSpan(
                  children: [
                    TextSpan(
                      text: 'Select a single sentence in the passage.', // Regular text before "Continue"
              ...
              SizedBox(height: 10),
              Text(
                "To select a sentence, click on any word in the sentence or select the sentence with the keyboard. To deselect a sentence, click or select it again, or select another sentence.",
