...
import 'package:moctest_project/screens/section-two/Question8/question_eight_help.dart';
...
class _TestCenterState extends State<QuestionEight> {
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => QuestionEightHelp() ),
                                );
                              },
                              child: Container(
                                color: Color(0xFF4D4C4D),
                    ...
                    child:  const Text.rich(
                      TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: ' | Question 8 of 12', // The bold "Continue"
                            style: TextStyle(
                              fontSize: 13,
                            ),
                          ),
