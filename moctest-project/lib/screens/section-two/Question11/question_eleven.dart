...
import '../Question10/question_ten_help.dart';
...
class QuestionEleven extends StatefulWidget {
  const QuestionEleven({super.key});

  @override
  _TestCenterState createState() => _TestCenterState();
}

class _TestCenterState extends State<QuestionEleven> {
                    ...
                    child:  const Text.rich(
                      TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: ' | Question 11 of 12', // The bold "Continue"
                            style: TextStyle(
                              fontSize: 13,
                            ),
                          ),
