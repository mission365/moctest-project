            ...
            children: [
              ...
              const Text.rich(
                TextSpan(
                  children: [
                    TextSpan(
                      text: 'Select one answer choice from each column.', // Regular text before "Continue"
              ...
              SizedBox(height: 10),
              Text(
                "To select an answer choice, click on it or select it with the keyboard. To deselect a choice, click on it or select it again, or select another choice in the same column.",
                style: TextStyle(fontSize: 13),
              ),
              SizedBox(height: 10),
              Text(
                "No credit is given unless you select the correct choice in each column.",
                style: TextStyle(fontSize: 13),
              ),
              SizedBox(height: 10),
              Text(
