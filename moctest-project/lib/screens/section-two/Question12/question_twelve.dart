...
import 'package:moctest_project/screens/section-two/Question12/question_twelve_help.dart';
import '../Question11/question_eleven.dart';
import '../exit_section.dart';
import '../quit_page.dart';
import '../review_page.dart';
import '../section_two_end.dart';

class QuestionTwelve extends StatefulWidget {
  const QuestionTwelve({super.key});

  @override
  _TestCenterState createState() => _TestCenterState();
}

class _TestCenterState extends State<QuestionTwelve> {
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => QuestionTwelveHelp() ),
                                );
                              },
                              child: Container(
                                color: Color(0xFF4D4C4D),
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => SectionTwoEnd()),
                                );
                              },
                              child: Container(
                                color: Color(0xFF365E90),
                    ...
                    child:  const Text.rich(
                      TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: ' | Question 12 of 12', // The bold "Continue"
                            style: TextStyle(
                              fontSize: 13,
                            ),
                          ),
